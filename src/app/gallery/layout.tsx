...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Browse Lil Sema's portfolio of professional photography and cinematic videography in Cameroon. Weddings, portraits, concerts, commercial work, and event coverage from Douala.",
  path: "/gallery",
  keywords: [
    "photography portfolio Cameroon",
    "wedding photos Douala",
