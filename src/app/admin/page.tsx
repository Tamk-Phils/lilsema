...
import { Upload, X, CheckCircle, Loader2, Trash2, Image as ImageIcon, Plus, FolderSync } from 'lucide-react';
        ...
        <div className="col-span-1 lg:col-span-2 space-y-10">
          <div className="flex justify-between items-end border-b border-white/5 pb-8">
            <div className="space-y-1">
              <h2 className="text-4xl font-black tracking-tighter leading-none uppercase">Manage <br /> Library</h2>
            ...
            <p className="text-[10px] font-black tracking-[0.3em] text-white/20 uppercase bg-white/5 px-4 py-2 rounded-full border border-white/5">{galleryItems.length} ASSETS</p>
          </div>
